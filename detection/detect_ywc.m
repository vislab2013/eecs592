function [boxes,model,ex] = detect_ywc(im, model, thresh, bbox, overlap, id, label)
...
% id: [label id level x y]
%   label   1: pos, -1: neg
%   id      image id
%   level   detection level in the pyramid
%   x       x position of head
%   y       y position of head
ex.blocks = [];
