...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) { 
  ...
  for (int x = 0; x < sizx; x++) {
    cout << "x: " << x << endl;
    cout << "sizy: " << sizy << " " << "ay: " << ay << " " << "by: " << by << " " << "offy: " << offy << " " << "leny: " << leny << endl;
    dt1d(vals+x*sizy, tmpM+x*leny, tmpIy+x*leny, 1, sizy, ay, by, offy, leny, step);
  }
  cout << tmpM[0] << tmpM[1] << tmpM[2] << tmpM[3] << endl;
   
  for (int y = 0; y < leny; y++) {
    cout << "y: " << y << endl;
    cout << "sizx: " << sizx << " " << "ax: " << ax << " " << "bx: " << bx << " " << "offx: " << offx << " " << "lenx: " << lenx << endl;
